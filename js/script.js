...
function init(){
    ...
    meinHandler("buttonReset", "click", canvasApp);
};//ENDE init
...
function anzeigenAusgaben(gefilterteAusgaben){
    ...
    for(var i = 0; i<ausgaben.length;i++){
        ...
        //---------------------------------------------------------------------------------
        /**
         * Elemente deklarieren, in denen Daten ausgegeben werden
         * @type {Element}
         */
        var positionContainer = document.createElement("div");
        positionContainer.setAttribute("class", "positionContainer");
        //-----------------------
        var nummerContainer = document.createElement("span");
        nummerContainer.setAttribute("class", "nummerContainer");
        //-----------------------
        var nameContainer = document.createElement("span");
        nameContainer.setAttribute("class", "nameContainer");
        //-----------------------
        var betragContainer = document.createElement("span");
        betragContainer.setAttribute("class", "betragContainer");
        //-----------------------
        ...
        /**
         * Icons zum manipulieren der Daten
         */
        ...
        var formatierteAusgabenID = counter + ". " + ausgaben[i].namePosition + ": " + ausgaben[i].betragPosition + " - " +
            "Data-Index: " + ausgaben[i].idPosition + "   Ausgaben-Index: " + i;
        ...
        /**
         * deklarierte Bereiche mit Daten befuellen
         */
        anzeigenAusgaben.appendChild(positionContainer);
        //-----------------------
        positionContainer.appendChild(nummerContainer);
        nummerContainer.appendChild(document.createTextNode(counter + "."));
        //-----------------------
        positionContainer.appendChild(nameContainer);
        nameContainer.appendChild(document.createTextNode(ausgaben[i].namePosition));
        //-----------------------
        positionContainer.appendChild(betragContainer);
        betragContainer.appendChild(document.createTextNode(ausgaben[i].betragPosition + " Euro"));
        //-----------------------
...
function anzeigenEinnahmen(gefilterteEinnahmen){
    ...
    for(var i = 0; i<einnahmen.length;i++){
        ...
        downArrow.title = einnahmen[i].namePosition + " zu Ausgabe aendern " + einnahmen[i].idPosition;
        //-----------------------
        var delete_id_ = "delete_id_";
        ...
        var formatierteEinnahmenID   = counter + ". " + einnahmen[i].namePosition + ": " + einnahmen[i].betragPosition + " - "
            + "Data-Index: " + einnahmen[i].idPosition + "   Einnahmen-Index: " + i;
        ...
        //-----------------------
        positionContainer.appendChild(nameContainer);
        nameContainer.appendChild(document.createTextNode(einnahmen[i].namePosition));
        //-----------------------
        positionContainer.appendChild(betragContainer);
        betragContainer.appendChild(document.createTextNode(einnahmen[i].betragPosition + " Euro"));
        //-----------------------
        positionContainer.appendChild(iconContainer);
        //-----------------------
        iconContainer.appendChild(leftSideIcon);
